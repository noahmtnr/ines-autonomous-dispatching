...
def preprocess(month, year):
    ...
    df.rename(columns={'vendor_name': 'vendor_id', 'Passenger_Count': 'passenger_count',
                       'Trip_Pickup_DateTime': 'pickup_datetime', 'Trip_Dropoff_DateTime': 'dropoff_datetime',
                       'Start_Lon': 'pickup_longitude', 'Start_Lat': 'pickup_latitude', 'End_Lon': 'dropoff_longitude',
                       'End_Lat': 'dropoff_latitude'}, inplace=True)
