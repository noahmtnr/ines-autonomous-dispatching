...
def insertIntoTrips(id, vendor_id, pickup_datetime, dropoff_datetime, passenger_count, pickup_longitude,
                    pickup_latitude, dropoff_longitude, dropoff_latitude, store_and_fwd_flag, trip_duration,
                    pickup_node, dropoff_node, route_length, provider, total_price):
    ...
    val = (id, vendor_id, pickup_datetime, dropoff_datetime, passenger_count, pickup_longitude, pickup_latitude,
           ...
           route_length, provider, total_price)
    mycursor.execute(sql, val)
    mydb.commit()
...
def addOrder():
    ...
    order = {"pickup_node": start_node, "delivery_node": final_node, "pickup_timestamp": pickup_datetime,
             "delivery_timestamp": dropoff_datetime}
