...
class Comparer:
    ...
    def compare_multipletrips(self):
        ...
        for key in self.agents:
            ...
            reward_mean = self.Average(reward_array)
            dist_mean = self.Average(dist_array)
            time_mean = self.Average(time_array)
            num_hubs_mean = self.Average(hubs_array)
