...
class GraphEnv(gym.Env):
    ...
    def step(self, action: int):
        ...
        # update max values
        # for i in range(len(self.learn_graph.adjacency_matrix('cost')[self.position].astype(int))):
        #     if (self.learn_graph.adjacency_matrix('cost')[self.position].astype(int)[i]>self.max_values[0]):
        #         self.max_values[0]=self.learn_graph.adjacency_matrix('cost')[self.position].astype(int)[i]
        # for i in range(len(self.learn_graph.adjacency_matrix('cost')[self.position].astype(int))):
