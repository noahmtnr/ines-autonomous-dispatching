...
class ManhattanGraph:
    ...
    def __init__(self, filename, num_hubs):
        filepath = ("/Users/noah/Desktop/Repositories/ines-autonomous-dispatching/data/graph/%s.graphml") % (filename)
    ...
    def generate_hubs(self, num_hubs: int = 70):#, opt: int = 0):
        ...
        hubs_file = pd.read_csv("/Users/noah/Desktop/Repositories/ines-autonomous-dispatching/data/hubs/new_hubs.csv")
        hubs = []
        i=0
    ...
    def setup_trips(self, start_time: datetime):
        ...
        all_trips = pd.read_csv('/Users/noah/Desktop/Repositories/ines-autonomous-dispatching/data/trips/preprocessed_trips.csv')
